...
const DEFAULT_FOLDER = process.env.CLOUDINARY_FOLDER || 'jambite-question-images';

function parseArgs(argv) {
	const args = { file: '', dir: DEFAULT_SOURCE_DIR, folder: DEFAULT_FOLDER, dryRun: false, all: false };
...
async function uploadOne(filePath, { cloudName, apiKey, apiSecret, folder, dryRun }) {
...
async function main() {
	...
	const targetFiles = args.file ? [path.resolve(args.file)] : await getFilesFromDir(path.resolve(args.dir));
